                        ...
                        ?>
                                    <article class="post_grid_item related_grid_item">
                                        ...
                                        <input type="hidden" class="next_post_id" value="<?= $previous_post_id;?>">
                                            ...
                                            <!--  -->
                                            <input type="hidden" class="before_img_url" value="<?= get_field('before_image')['url']?>">
                                            <input type="hidden" class="after_img_url" value="<?= get_field('after_image')['url']?>">
                                            ...
                                            <!--  -->
                                            <img class="featured_image" src="<?= get_the_post_thumbnail_url();?>" alt="image">
